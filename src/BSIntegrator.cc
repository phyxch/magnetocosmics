...
BSIntegrator* BSIntegrator::instance = 0;
////////////////////////////////////////////////////////////////////////////////
//
BSIntegrator::BSIntegrator()
{
  theEquation= 0;
  eps=1.0e-5;
  hmin=1.0e-50;
...
////////////////////////////////////////////////////////////////////////////////
//
BSIntegrator::BSIntegrator(BSEquation* anEquation)
{
  eps=1.0e-5;
  hmin=1.0e-50;
  hmax=1.0e50;
...
////////////////////////////////////////////////////////////////////////////////
//
BSIntegrator* BSIntegrator::getInstance()
{
    if (instance == 0) instance = new BSIntegrator;
  return instance;
}  
...
//
//integration
bool BSIntegrator::do_integration
       (G4double ystart[], const G4double x1, const G4double h1, 
...
void BSIntegrator::bsstep(G4double y[], G4double dydx[], G4double &xx, 
...
////////////////////////////////////////////////////////////////////////////////
//
void BSIntegrator::mmid(const G4double y[], const G4double dydx[], 
	                ...
	                const G4int nstep, G4double yout[])
{
  ...
  theEquation->SetLastSubPosition(G4ThreeVector(yn[0],yn[1],yn[2]));
...
////////////////////////////////////////////////////////////////////////////////
//
void BSIntegrator::pzextr(const G4int iest, const G4double xest, 
