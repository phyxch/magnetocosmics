...
//
//
// $Id: G4UIGainPHPServer.hh,v 1.1.1.1 2014/06/02 18:39:07 hexc Exp $
// $Name:  $
//


#ifndef G4UIGainPHPServer_h
#define G4UIGainPHPServer_h 1
...
// G4UIGainPHPServer provides socket connection to remote Gain client.
...
class G4UIGainPHPServer : public  G4VBasicShell {
private:
  G4String prefix;
...
public:
  ...
  // Usage:  G4UIsession * gainSession = new G4UIGainPHPServer();
...
public:
  //  G4UIGainPHPServer(G4VUIshell* aShell=0);
   G4UIGainPHPServer();
  //G4UIGainPHPServer(void){}
    ~G4UIGainPHPServer();
  //~G4UIGainPHPServer(void){}
